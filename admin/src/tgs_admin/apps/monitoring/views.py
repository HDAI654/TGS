...
def channels(request):
    return render(request, "admin/monitoring/channels.html", {"channels": channels_status()})


@staff_member_required
def workers(request):
    return render(request, "admin/monitoring/workers.html", {"workers": worker_status()})
