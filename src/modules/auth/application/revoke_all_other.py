...
class RevokeAllOtherSessionsService:
    def __init__(
        self,
    ...
    async def execute(self, access_token: str, current_device: str) -> None:
        logger.info("Revoking all user sessions except current session")
        # Decode token
        ...
        # Delete all active sessions for this user except current session
