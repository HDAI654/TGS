...
class ForgetPasswordVerificationService:
    def __init__(
        self,
        uow: IUnitOfWork,
    ...
    async def execute(self, email: str) -> None:
        logger.info("Sending email verification for password-reset")

        email_vo = Email(email)

        # Check user exist
        if not await self.uow.users.exists_by_email(email_vo):
        ...
        await self.email_sender.send(
            ...
            body=self._build_plain_text_body(
                f"{Config.RESET_PASSWORD_URL}/{ver_token.value}"
            ),
    ...
    def _build_plain_text_body(self, link: str) -> str:
        return f"""
            Password Reset Request — {Config.APP_NAME}
            ...
            This link will expire in {Config.RESET_PASSWORD_EXPIRE_MINUTES // 60} hours.

            If you did not request a password reset, please ignore this email. 
            Your account security is important to us, and no changes will be made unless you click the link above.
            ...
            <html>
                ...
                <body>
                    <div class="container">
                        ...
                        <p class="greeting"><strong>Password Reset Request</strong></p>
                        <p class="text">We received a request to reset the password for your {Config.APP_NAME} account.</p>
                        ...
                        <p class="expiry">⏳ This link expires in <strong>{Config.RESET_PASSWORD_EXPIRE_MINUTES // 60} hours</strong>.</p>
